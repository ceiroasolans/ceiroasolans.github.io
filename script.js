...
function instructions3() {
    ...
    for (let group in emotionGroups) {
        let groupText = {
            positive: {
                before: `<h2 style="text-align:center;">Your CAPS Feedback</h2>...`,
                after: `<p style="text-align:justify;">2- Within the negative videos:...</p>`
            },
            negative: {
                after: `<p style="text-align:justify;">3-We also included two special emotional situations (here: videos)...</p>`
            },
            special: {
                before: `<h2 style="text-align:center;">Your Special Emotions Feedback</h2>`
            }
        };

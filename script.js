...
function MoviePreferences() {
    ...
    const genres = [
        "Adventure", "Comedy", "Drama", "Horror", "Fiction", "Romance", "Documentary", "Thriller"
    ];
    
    const scale = ["Not at all", "Neutral", "Very much"];
    ...
    mainQuestion.textContent = "How do you like the following genres of movies?";
    ...
    genres.forEach((genre) => {
        ...
        for(let i = 0; i <= 6; i++){ 
            ...
            if (i === 0) label.textContent += scale[0]; 
            else if (i === 3) label.textContent += scale[1];
            else if (i === 6) label.textContent += scale[2];
...
//var feedbackContainer = document.getElementById("feedbackContainer"); // why is this here? Not needed...

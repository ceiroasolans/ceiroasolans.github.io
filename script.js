...
function instructions3() {
    ...
    let groupText = {
        positive: `<h2 style="text-align:center;">Your CAPS Feedback</h2>
            <p style="text-align:justify;">...`,
        negative: `<p style="text-align:justify;">2- Within the negative videos:...`,
        special: `<p style="text-align:justify;">3-We also included two special emotional situations (here: videos)....`
    };
